...
func TestValidEntryWhenAccountCorrect(t *testing.T) {
	data := [3][27]byte{
		{' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', ' ', ' '},
		{'|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', '_', ' ', ' ', ' ', '|'},
		{'|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', ' ', '_', '|', ' ', ' ', '|'},
	...
	assert.Equal(t, "000000051", entry.toString())
	assert.Equal(t, true, entry.isValid())
}

func TestValidEntryWhenAccountIncorrect(t *testing.T) {
	data := [3][27]byte{
		{' ', ' ', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', ' ', ' '},
		{' ', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', ' ', '|', '|', '_', ' ', ' ', ' ', '|'},
		{' ', ' ', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', '|', '_', '|', ' ', '_', '|', ' ', ' ', '|'},
	...
	assert.Equal(t, "100000051", entry.toString())
	assert.Equal(t, false, entry.isValid())
}

func TestEntryToAccountStringWithIllegibleCharacter(t *testing.T) {
	data := [3][27]byte{
		{' ', '_', '|', ' ', '_', ' ', ' ', ' ', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ',},
		{' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|',},
		{' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|',},
	...
	assert.Equal(t, "?3?333333", entry.toString())
}

func TestEntryIllegal(t *testing.T) {
	data := [3][27]byte{
		{' ', '_', '|', ' ', '_', ' ', ' ', ' ', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ', ' ', '_', ' ',},
		{' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|',},
		{' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|', ' ', '_', '|',},
	...
	assert.Equal(t, "?3?333333", entry.toString())
	assert.Equal(t, true, entry.isIllegal())
}
